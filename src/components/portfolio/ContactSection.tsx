...
const ContactSection = () => {
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/sayaksen",
      label: "GitHub",
      color: "hover:text-gray-300",
    },
    {
      icon: Linkedin,
      href: "https://linkedin.com/in/sayaksen",
      label: "LinkedIn",
      color: "hover:text-blue-400",
    },
    {
      icon: Twitter,
      href: "https://twitter.com/sayaksen",
      label: "Twitter",
      color: "hover:text-blue-300",
    },
    {
      icon: Mail,
      href: "mailto:sayak@sayaksen.me",
      label: "Email",
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          Ready to bring your ideas to life? Let's discuss your next project or
