  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Three.js/WebGL', level: 75, color: 'from-purple-500 to-pink-500' },
        { name: 'Framer Motion', level: 80, color: 'from-pink-500 to-purple-500' }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: 'Python/Django', level: 78, color: 'from-yellow-500 to-orange-500' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'AWS/Vercel', level: 68, color: 'from-orange-500 to-yellow-500' },
        { name: 'Figma/Design', level: 75, color: 'from-purple-500 to-indigo-500' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Machine Learning', level: 40, color: 'from-indigo-500 to-purple-500' },
        { name: 'Blockchain/Web3', level: 35, color: 'from-yellow-500 to-orange-500' },
  ...
  return (
    <section id="skills" ref={ref} className="min-h-screen py-20 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          A comprehensive overview of my technical expertise and ongoing learning journey
        </motion.p>
                ...
                {category.skills.map((skill, skillIndex) => (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-gray-400">{animatedSkills[skill.name] || 0}%</span>
                    </div>
        ...
        >
          <div className="backdrop-blur-md bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-8 border border-white/10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Full Stack Development', 'AI/ML Integration', '3D Web Experiences', 'Performance Optimization'].map((focus, index) => (
                <motion.span
                  key={focus}
